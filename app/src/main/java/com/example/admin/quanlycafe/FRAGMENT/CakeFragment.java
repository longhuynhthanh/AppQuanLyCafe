...
public class CakeFragment extends Fragment {
    private static CakeFragment instance;

    public static CakeFragment Instance()
    {
        if(instance == null)
        {
            instance = new CakeFragment();
        }
        return instance;
    }
    private void Instance(CakeFragment instance)
    {
        CakeFragment.instance = instance;
    }
